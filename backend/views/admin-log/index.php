          	...
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'admin-log-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('admin-log/index')]); ?>
                  ...
                  <div class="form-group" style="margin: 5px;">
                      <input type="text" class="form-control" id="query[id]" name="query[id]"  value="<?=isset($query["id"]) ? $query["id"] : "" ?>" placeholder="ID">
                  </div>
                <div class="form-group" style="margin: 5px;">
                    <input type="text" class="form-control" id="query[create_user]" name="query[create_user]"  value="<?=isset($query["create_user"]) ? $query["create_user"] : "" ?>" placeholder="用户">
                </div>
                <div class="form-group" style="margin: 5px;">
