                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="pre_id" class="form-control" placeholder="选填项">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="bank_tel" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    $('#save').click(function () {
        ...
        $.post('<?= Url::toRoute(['admin-member/create'])?>',{_csrf:_csrf,pre_id:pre_id,name:name,tel:tel,id_card:id_card,bank_card:bank_card,
