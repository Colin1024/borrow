                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="key" class="form-control" value="<?= $model['key']?>"><span style="color:red">*具有唯一性</span>
...
<script>
    ...
    ue.ready(function () {
       ue.setContent('<?= htmlspecialchars_decode($model['content'])?>') ;
    });
    ...
    $('#save').click(function () {
        ...
        $.post('<?= Url::toRoute(['admin-page/update'])?>',{_csrf:_csrf,id:id,key:key,title:title,content:content},function (res) {
            if(res.status === 200){
