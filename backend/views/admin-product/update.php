                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="label" class="form-control" value="<?= $model['label']?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <img src="<?= Url::base() ?><?= $model['thumb']?>" id="thumb" width="75" height="65" onclick="fileSelect()">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="apply_num" class="form-control" value="<?= $model['apply_num']?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">借款最小金额</label>
                            <div class="col-sm-2">
                                <input type="text" name="min_money" class="form-control" value="<?= $model['min_money']?>">
                            </div>
                            <label class="col-sm-2 control-label">借款最大金额</label>
                            <div class="col-sm-2">
                                <input type="text" name="max_money" class="form-control" value="<?= $model['max_money']?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="other_info" class="form-control" value="<?= $model['other_info']?>">
                            </div>
                            <div class="col-sm-4">
...
<script>
    var a = "<?= htmlspecialchars_decode($model['apply_process'])?>";
    // ueditor
    ...
    apply_process.ready(function () {
        apply_process.setContent('<?= htmlspecialchars_decode($model['apply_process'])?>');
    });
    apply_condition.ready(function () {
        apply_condition.setContent('<?= htmlspecialchars_decode($model['apply_condition'])?>');
    });
    guide.ready(function () {
        guide.setContent('<?= htmlspecialchars_decode($model['guide'])?>');
    });
...
<script>
    ...
    $('#save').click(function () {
        ...
        $.post('<?= Url::toRoute(['admin-product/update'])?>',{_csrf:_csrf,id:id,name:name,description:description,thumb:thumb,background:background,
            is_show:is_show,cate_id:cate_id,auth_need:auth_need,tel_auth_need:tel_auth_need,apply_process:apply_process,apply_condition:apply_condition,guide:guide,
